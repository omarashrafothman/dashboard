        ...
        <table className="table align-items-center mb-0 ">
          <thead className="col-3 ">
            <tr>
              ...
              <th className="text-center text-capitalize text-secondary text-xxs font-weight-bolder opacity-7 col-3">
                Title
              </th>
              <th className="text-capitalize text-secondary text-xxs font-weight-bolder opacity-7 col-3">
                img
              </th>

              <th className="text-capitalize text-secondary text-xxs font-weight-bolder opacity-7 ps-2 col-4">
                Description
              </th>
              <th className="text-capitalize text-secondary text-xxs font-weight-bolder opacity-7 ps-2 col-4">
                Actions
